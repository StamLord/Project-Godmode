...
namespace KinematicCharacterController.Examples
{
    public class PlanetManager : MonoBehaviour, IMoverController
    {
        ...
        private List<AdvancedController> _characterControllersOnPlanet = new List<AdvancedController>();
        ...
        public void UpdateMovement(out Vector3 goalPosition, out Quaternion goalRotation, float deltaTime)
        {
            ...
            foreach (AdvancedController cc in _characterControllersOnPlanet)
            {
